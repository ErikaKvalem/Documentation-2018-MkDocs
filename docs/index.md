...
Installing Docker is the first step of this process.  To download it and install it, use the following [link](https://www.docker.com/community-edition#/download) {:target="_blank"} should be used: 
